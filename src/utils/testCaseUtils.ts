import { TestCase, PRDSummary, UploadedDocument, TestCaseType } from "@/types";
...
export const generateMockData = (documentName: string): UploadedDocument => {
  ...
  const summary: PRDSummary = {
    ...
    description:
      "This document outlines the requirements for the application, including functional and non-functional requirements.",
    keyPoints: [
